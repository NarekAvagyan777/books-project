...
export default function Header({ theme, setTheme }) {
  ...
  return (
    <div className={`${styles.header} d-md-flex pt-2 pb-2 mb-1 align-items-center ${theme === 'dark' ? styles.dark : ''}`}>
      ...
      <div className='col-md-4 col-10 offset-1 offset-md-0 d-flex align-items-center justify-content-center'>
        ...
        <div className='col-4 d-flex justify-content-md-center justify-content-end align-items-center'>
          ...
          {
            theme === 'light' ? <a className={styles.svgAnchor} onClick={() => setTheme('dark')}>
            ...
            </a> : <a className={styles.svgAnchor} onClick={() => setTheme('light')}>
